...
@section('title', 'Spire Technology Limited-Contact')
    ...
    <section class="w-full py-[5rem]">
        <div class="container mx-auto px-4 flex lg:flex-row flex-col gap-4">
            <div class="lg:w-1/2 w-full ">
                ...
                <p class="text-base text-[#7A7A7A] mt-4">Give us a call or drop by anytime, we endeavour to answer all
                ...
                <div class="w-full p-[1rem] hover:shadow rounded-md mt-4 flex gap-4">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <p class="text-[#7A7A7A]">+8801712-444267</p>
            ...
            <div class="lg:w-1/2 w-full p-[4rem] bg-gradient-to-r from-[#D3592C] to-[#612050]">
                ...
                <form id="whatsappForm" class="flex flex-col gap-3 mt-4">
                    <input id="name" type="text" required
                        class="bg-[#BF7A76] py-2 px-4 outline-none rounded-md text-white" placeholder="Your Name">

                    <input id="email" type="email" required
                        class="bg-[#BF7A76] py-2 px-4 outline-none rounded-md text-white" placeholder="Your Email">

                    <textarea id="message" rows="8" required class="bg-[#BF7A76] py-2 px-4 outline-none rounded-md text-white"
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        form.addEventListener("submit", function(e) {
            ...
            let whatsappNumber = "8801712444267"; // no +, no space
